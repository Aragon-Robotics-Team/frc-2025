...
public class DriftSwerveModule extends SubsystemBase {
  ...
  public DriftSwerveModule(int driveId, int turnId, int absoluteEncoderPort, double absoluteEncoderOffset,boolean driveReversed, boolean turningReversed, String moduleId) 
  {
